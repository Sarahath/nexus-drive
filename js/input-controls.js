...
const RC={
  ...
  _action(a){
    if(a==='horn'){ if(typeof Aud!=='undefined'&&Aud.honk)Aud.honk(); }
      ...
      // Same stationary/manual reset as the other Free Mode entry points —
      // this remote command can fire mid-mission, so the car must not
      // carry over speed or autopilot into Free Mode.
